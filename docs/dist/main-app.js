...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function W(i,e){if(!i)return;if(typeof i=="string")return z(i,e);var t=Object.prototype.toString.call(i).slice(8,-1);if(t==="Object"&&i.constructor&&(t=i.constructor.name),t==="Map"||t==="Set")return Array.from(i);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return z(i,e)}function z(i,e){(e==null||e>i.length)&&(e=i.length);for(var t=0,r=new Array(e);t<e;t++)r[t]=i[t];return r}function R(i){if(typeof Symbol!="undefined"&&Symbol.iterator in Object(i))return Array.from(i)}function U(i){if(Array.isArray(i))return i}function g(i,e,t){var r=e.get(i);if(!r)throw new TypeError("attempted to set private field on non-instance");if(r.set)r.set.call(i,t);else{if(!r.writable)throw new TypeError("attempted to set read only private field");r.value=t}return t}function u(i,e){var t=e.get(i);if(!t)throw new TypeError("attempted to get private field on non-instance");return t.get?t.get.call(i):t.value}import{LitElement as k,html as _,css as x,customElement as E}from"../web_modules/lit-element.js";import{query as l}from"../web_modules/lit-element/lib/decorators.js";import"../web_modules/@material/mwc-button.js";import"../web_modules/@material/mwc-checkbox.js";import"../web_modules/@material/mwc-drawer.js";import"../web_modules/@material/mwc-fab.js";import"../web_modules/@material/mwc-formfield.js";import"../web_modules/@material/mwc-top-app-bar.js";import"../web_modules/@material/mwc-icon-button.js";import"../web_modules/@material/mwc-icon-button-toggle.js";import"../web_modules/@material/mwc-snackbar.js";import"../web_modules/@material/mwc-dialog.js";import"../web_modules/@material/mwc-textfield.js";import"./groceries-list.js";import{GroceryStore as P}from"./grocery-store.js";import{Workbox as O}from"../web_modules/workbox-window.js";const v=new(C=(h=new WeakMap,m=new WeakMap,p=new WeakMap,class extends EventTarget{constructor(){super();h.set(this,{writable:!0,value:window.NDEFReader?new NDEFReader:new EventTarget}),m.set(this,{writable:!0,value:!1}),p.set(this,{writable:!0,value:null}),u(this,h).addEventListener("reading",i=>{if(u(this,m))return;this.dispatchEvent(new NDEFReadingEvent(i.type,i))})}async write(i,e){g(this,m,!0),await u(this,h).write(i,e),g(this,m,!1)}scan(){u(this,p)||(g(this,p,new AbortController),u(this,h).scan({signal:u(this,p).signal}))}stop(){u(this,p)&&(u(this,p).abort(),g(this,p,null))}}),C);export let OnboardingWizard=y([E("onboarding-wizard")],function(i,e){class t extends e{constructor(...r){super(...r);i(this)}}return{F:t,d:[{kind:"field",decorators:[l("mwc-dialog")],key:"_dialog",value:void 0},{kind:"field",static:!0,key:"styles",value(){return x`
  ...
  `}},{kind:"field",decorators:[l("onboarding-wizard")],key:"_wizard",value:void 0},{kind:"field",decorators:[l("add-dialog")],key:"_dialog",value:void 0},{kind:"field",decorators:[l("mwc-drawer")],key:"_drawer",value:void 0},{kind:"field",decorators:[l("mwc-snackbar")],key:"_snackbar",value:void 0},{kind:"field",decorators:[l("#actionButton")],key:"_actionBtn",value:void 0},{kind:"field",decorators:[l("#permissionToggle")],key:"_permissionToggle",value:void 0},{kind:"method",key:"firstUpdated",value:function(){const o=this._drawer,a=o.parentNode;if(a.addEventListener("MDCTopAppBar:nav",n=>{o.open=!o.open}),this._snackbar.addEventListener("MDCSnackbar:closed",n=>{n.detail.reason==="action"&&window.location.reload(),this._snackbar.labelText="",this._actionBtn.textContent=""}),v.addEventListener("reading",n=>{const s=new TextDecoder;for(let c of n.message.records){const d=JSON.parse(s.decode(c.data));d.product&&this._store.set(d.product,d.description)}}),navigator.permissions.query({name:"nfc"}).then(async n=>{const s=()=>{console.log("permission state",n.state),n.state==="granted"?(v.scan(),this._permissionToggle.on=!0):n.state==="denied"?this._permissionToggle.on=!1:n.state==="prompt"&&this._wizard.open()};s(),n.addEventListener("change",s)}).catch(n=>{this._snackbar.labelText="NFC is not supported; try enabling in about:flags",this._actionBtn.textContent="",this._snackbar.show()}),"serviceWorker"in navigator){const n=new O("sw.js");n.addEventListener("installed",s=>{s.isUpdate?(console.log("Service worker was updated"),this._snackbar.labelText="A newer version of the app is available.",this._snackbar.show()):console.log("Service worker activated for the first time.")}),n.register()}}},{kind:"method",key:"_toggleScan",value:async function(o){if(!window.NDEFReader){this._snackbar.labelText="NFC is not supported; try enabling in about:flags",this._actionBtn.textContent="",this._snackbar.show();return}console.log("scan should turn on",o);try{o?(await v.scan(),this._snackbar.labelText="Add item or touch an NFC tag.",this._actionBtn.textContent="",this._snackbar.show()):(v.stop(),this._snackbar.labelText="NFC tags scan operation is disabled.",this._actionBtn.textContent="",this._snackbar.show())}catch(a){console.error(a),this._permissionToggle.on=!1;const n=await navigator.permissions.query({name:"nfc"});n.state=="denied"&&a.name=="NotAllowedError"&&(this._snackbar.labelText="NFC permission is denied, please grant it in browser settings.",this._actionBtn.textContent="",this._snackbar.show())}}},{kind:"method",key:"render",value:function(){return _`
      ...
      <mwc-drawer hasHeader type=modal>
        ...
        <div slot="appContent">
          <mwc-top-app-bar>
            ...
            <mwc-icon-button-toggle slot="actionItems" id="permissionToggle" @MDCIconButtonToggle:change=${o=>this._toggleScan(o.detail.isOn)}>
